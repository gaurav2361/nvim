...
(literal) @string (#set! priority 105)

(comment) @comment @spell (#set! priority 105)

(marginalia) @comment (#set! priority 105)
...
(parameter) @variable.parameter (#set! priority 105)
...
[
  ...
  (keyword_volatile)
] @keyword.modifier (#set! priority 105)
...
[
  ...
  (keyword_except)
  (keyword_intersect)
] @keyword.operator (#set! priority 105)
